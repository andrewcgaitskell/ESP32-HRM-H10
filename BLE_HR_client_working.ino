...
//BLE_ADDRESS = "CB:48:AD:ED:3F:63" # changed this to my own
...
static void notifyCallback(
  ...
  bool isNotify) {
    ...
    //Serial.println("pData: %d", dataIndPtr->pData[0]);
}
...
//Your client app is performing scan for only 5 sec, then it never try to scan again.
//You can use pBLEScan->start(0) (forever),
//and add BLEClentCallbacks and with the same line (pBLEScan->start(0)) in onDisconnect().
